...
var (
	...
	ErrUpdateNoSuchRow  = errors.New("can't update no such row for the specified identifier")
	ErrGetByIDNoSuchRow = errors.New("can't get no such row for the specified identifier")
